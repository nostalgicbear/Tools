...
namespace DigitalOpus.MB.MBEditor
{
    public class MB3_TextureBakerEditorInternal
    {
        ...
        public void DrawGUI(SerializedObject textureBaker, MB3_TextureBaker momm, UnityEngine.Object[] targets, System.Type editorWindow)
        {
            ...
            if (GUILayout.Button(new GUIContent("Custom: Filter incorrect LODs", "Removes objects without renderer at LOD 0 \n" +
                ...
                "Adds LOD levels for objects missing LOD1 and LOD2 \n"), style))
            {
                ...
                foreach (MB3_TextureBaker baker in selectedBakers)
                {
                    ...
                    baker.objsToMesh = CustomTools.MeshBakerUtilities.Custom_MeshBakerUtility.ApplyMissingLODLevel(baker.objsToMesh); //Keeping this separate on purpose. Separates removal and addition of components.
                }
            }
